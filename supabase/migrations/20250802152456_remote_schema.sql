...
-- Create trigger  to create new user in public.users table
...
create policy "Allow all operations for all auth users"
on "public"."order"
as permissive
for all
to authenticated
...
create policy "Enable delete for users admin only"
on "public"."product"
as permissive
for delete
to authenticated
